...
$(document).ready(function () {
    ...
    $('#forget-password').on('click', function () {
        $('#signup-form').css({ display: 'none' });
        $('#signin-form').css({ display: 'none' });
        $('#panel-ask').css({ display: 'none' });
        $('#forget-password-panel').css({ display: 'block' });
    });

    $('#country').on('change', function () {
        let countryName = document.getElementById('country').value;
        let countryCode = returnCountryName(countryName)[0].dial_code;
    ...
    $('#country-code').on('change', function () {
        ...
        let countryName = returnCountry('+' + countryCode)[0].name;
    ...
    $('.registration-form').on('submit', function (e) {
        ...
        $.ajax({
            ...
            url: '../modules/frank/ajax/signup.php',
            method: 'POST',
            data: $form.serialize(),
            success: function(response) {
                response = JSON.parse(response);
    ...
    $('.signin-form').on('submit', function (e){
        ...
        $.ajax({
            // url: '../modules/frank/ajax/postAjax.php',
            url: '../modules/frank/ajax/signin.php',
            method: 'POST',
            data: $form.serialize(),
            success: function(response) {
                response = JSON.parse(response);
    ...
    $('.forget-password-form').on('submit', function (e){
        ...
        $form = $(this);
        $.ajax({
            url: '../modules/frank/ajax/forgetPassword.php',
            method: 'POST',
            data: $form.serialize(),
            success: function(response) {
                response = JSON.parse(response);
