                    ...
                    <div class="tabPanel" style="height: 450px;overflow-y: scroll;">
                        <table class="table tabPanelTable">
                            ...
                            <tr>
                                <th class="col-sm-2">Tracking number</th>
                                <th class="col-sm-2">Recipients</th>
                                <th class="col-sm-2">Cancelled by</th>
                                <th class="col-sm-2 ">Delivery dates</th>
                                <th class="col-sm-2">Status</th>
                                <th class="col-sm-2"></th>
                            </tr>
                            ...
                            {foreach $api_franks as $api_frank}
                                ...
                                $api_frank['status'] === 'cancelledbyadmin' && $api_frank['isReturnOrder'] === false}
                                    <tr>
                                        ...
                                        {if $api_frank['status'] === 'cancelledbystore'}
                                            <td class="col-sm-2">Store</td>
                                        {/if}
                                        {if $api_frank['status'] === 'cancelledbytransporter'}
                                            <td class="col-sm-2">Transporter</td>
                                        {/if}
                                        {if $api_frank['status'] === 'cancelledbyadmin'}
